...
/**
 * Clase principal que permite crear un empleado y mostrar su información
 * salarial.
 * Utiliza diálogos gráficos (JOptionPane) para solicitar los datos del
 * empleado.
 * 
 * @author Usuario
 * @version 1.0
...
public class empleadoMain {
    ...
    public static void main(String[] args) {
        ...
        double sueldoBasico = Double
                .parseDouble(JOptionPane.showInputDialog("Ingrese el sueldo basico del empleado: "));
