...
/**
 * Representa un producto comercial con su información de costos, stock y laboratorio proveedor.
 * 
 * @author Gabi
 * @version 1.0
 */
public class producto {
    ...
    /**
     * Constructor que inicializa un producto con sus datos comerciales y stock inicial.
     * 
    ...
    /**
     * Permite ajustar el stock sumando o restando una cantidad mediante diálogo interactivo.
     * 
    ...
    /**
     * Calcula el valor total del stock multiplicando la cantidad por el precio de costo.
     * 
    ...
    /**
     * Calcula el precio de contado aplicando un 5% de descuento sobre el precio de lista.
     * 
    ...
    /**
     * Devuelve una línea representativa con descripción, precio de lista y precio contado.
     * 
